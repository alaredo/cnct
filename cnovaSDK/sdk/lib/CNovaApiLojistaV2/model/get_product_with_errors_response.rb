module CNovaApiLojistaV2
  module Model
	  # 
	  class GetProductWithErrorsResponse < BaseObject
	    attr_accessor :sku_id, :sku_seller_id, :product_seller_id, :title, :description, :brand, :gtin, :categories, :images, :videos, :price, :stock, :dimensions, :gift_wrap, :attributes, :errors
