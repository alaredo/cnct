...
class PromotionsControllerTest < ActionController::TestCase
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post :create, promotion: { amount: @promotion.amount, name: @promotion.name, orderItem_id: @promotion.orderItem_id, type: @promotion.type }
    end
  ...
  test "should update promotion" do
    patch :update, id: @promotion, promotion: { amount: @promotion.amount, name: @promotion.name, orderItem_id: @promotion.orderItem_id, type: @promotion.type }
    assert_redirected_to promotion_path(assigns(:promotion))
  end
