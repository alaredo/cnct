...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { descricao: @produto.descricao, empresa_id: @produto.empresa_id, saldo: @produto.saldo, valor: @produto.valor }
    end
  ...
  test "should update produto" do
    patch :update, id: @produto, produto: { descricao: @produto.descricao, empresa_id: @produto.empresa_id, saldo: @produto.saldo, valor: @produto.valor }
    assert_redirected_to produto_path(assigns(:produto))
  end
