...
class EmpresasControllerTest < ActionController::TestCase
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post :create, empresa: { login: @empresa.login, name: @empresa.name, passwd: @empresa.passwd, url: @empresa.url }
    end
  ...
  test "should update empresa" do
    patch :update, id: @empresa, empresa: { login: @empresa.login, name: @empresa.name, passwd: @empresa.passwd, url: @empresa.url }
    assert_redirected_to empresa_path(assigns(:empresa))
  end
